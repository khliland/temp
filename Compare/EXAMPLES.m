...
ylabel('% explained variance')
grid on
legend('N-PLS','N-CPLS','N-CPLS with Y_{additional}','Location','SouthEast')
pp = get(gcf,'PaperPosition'); set(gcf,'PaperPosition',[0,0,pp(3),pp(4)]); set(gcf,'PaperSize',[pp(3),pp(4)])
...
grid on
legend('N-PLS','N-CPLS','N-CPLS with Y_{additional}','Location','SouthEast','AutoUpdate',false)
i81 = find(R2a(:,1)>=80,1); i82 = find(R2b(:,1)>=80,1); i83 = find(R2c(:,1)>=80,1);
i91 = find(R2a(:,1)>=90,1); i92 = find(R2b(:,1)>=90,1); i93 = find(R2c(:,1)>=90,1);
plot([i81,i82,i83,i91,i92,i93], [R2a(i81,1),R2b(i82,1),R2c(i83,1),R2a(i91,1),R2b(i92,1),R2c(i93,1)],'xk')
plot([i81,i82,i83,i91,i92,i93], [R2a(i81,1),R2b(i82,1),R2c(i83,1),R2a(i91,1),R2b(i92,1),R2c(i93,1)],'or')
